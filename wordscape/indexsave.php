...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['recaptcha_response'])):
    ...
    if (!isLocalHost()) {
        ...
        $recaptcha_secret = '6Lf8ZpcUAAAAALSWLWC4yhWo_x-w-a75dinAhmWa';
...
<head>
    ...
    <meta name="twitter:image" content="//cs.stcc.edu/specialapps/wordscape/img/wordscape.jpg">

    <meta property="og:url" content="//cs.stcc.edu/specialapps/wordscape/" />
    ...
    <meta property="og:image" content="//cs.stcc.edu/specialapps/wordscape/img/wordscape.jpg" />
...
<body>
    ...
    <script src='//www.google.com/recaptcha/api.js?render=6Lf8ZpcUAAAAAIp3zLy1Uk8NG6fcyZZCCMjmUMS0'></script>
    <script>
    $(function() {
        grecaptcha.ready(function () {
                grecaptcha.execute('6Lf8ZpcUAAAAAIp3zLy1Uk8NG6fcyZZCCMjmUMS0', { action: 'wordscapeform' })
                    .then(function (token) {
